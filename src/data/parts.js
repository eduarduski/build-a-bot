// ep - 'require.context' is part of webpack; it says make webpack aware of the image url
//      so that we can use it throught json file in order to pass in a realtive url
const images = require.context('/images', true, /\.png$/);

// ep - 'parts' variable
const parts = {

  // ep - json object with properties that contains an array of 'head' parts
  heads: [
    {
      id: 1,
      description:
